...
@testset "IsotopicCalc.jl" begin
    ...
    @testset "monoisotopic_massProtonated" begin
        # Test protonated masses
        acetone = monoisotopic_mass("C3H6O")
        acetone_protonated = monoisotopic_massProtonated("C3H6O")
        ...
        @test isapprox(monoisotopic_massProtonated("C3H6O"), pattern_h[1][1], atol=1e-6)
    end
    ...
    @testset "Consistency Checks" begin
        ...
        @test isapprox(
            isotopic_patternProtonated("C3H6O")[1][1],
            monoisotopic_massProtonated("C3H6O"),
            atol=1e-6
        )
    end
